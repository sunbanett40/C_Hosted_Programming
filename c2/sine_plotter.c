...
int main()
{
    ...
    for (;;)                                                    /*Endless loop*/
    {
        ...
        y = ((sin(((FREQ_A * x) + PHASE_A) * pi / 180) +         /*calculate value of y*/
             sin(((FREQ_B * x) + PHASE_B) * pi / 180) + 2) / 4);                        /*Random number used to create noise, from tutorial point*/
